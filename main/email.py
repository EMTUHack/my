...
def verify_email(hacker):
    ...
    send_mail(
        '[{}] Verificar Email'.format(settings.HACKATHON_NAME),
        msg_plain,
        fr,
        [to],
        html_message=msg_html,
...
def notify_admitted(hacker):
    ...
    send_mail(
        '[{}] Aplicação aceita!'.format(settings.HACKATHON_NAME),
        msg_plain,
        fr,
        [to],
        html_message=msg_html,
...
def notify_waitlist(hacker):
    ...
    send_mail(
        '[{}] Fila de Espera'.format(settings.HACKATHON_NAME),
        msg_plain,
        fr,
        [to],
        html_message=msg_html,
...
def notify_unwaitlist(hacker):
    ...
    send_mail(
        '[{}] Abriu uma vaga!'.format(settings.HACKATHON_NAME),
        msg_plain,
        fr,
        [to],
        html_message=msg_html,
...
def notify_decline(hacker):
    context = {
        ...
        'subtitle': '',
        'description': 'Avaliamos sua aplicação e infelizmente decidimos que você não poderá fazer parte dessa edição do {}.<br>Esperamos ver você em edições futuras!'.format(settings.HACKATHON_NAME),
        'project_url': settings.ROOT_URL,
        'hackathon_name': settings.HACKATHON_NAME,
        'facebookHandle': settings.FACEBOOK_HANDLE
    }
    ...
    send_mail(
        '[{}] Sobre sua aplicação'.format(settings.HACKATHON_NAME),
        msg_plain,
        fr,
        [to],
        html_message=msg_html,
